...
.thermometer-inside{
    ...
    border-radius: 55px;
    z-index: 9;
    background: linear-gradient(0deg, rgba(0,13,51,1) 0%, rgba(44,9,78,1) 19%, rgba(216,37,162,1) 60%, rgba(253,0,107,1) 100%) no-repeat bottom;
    background-size: 100% 300px;
    transition: all 0.2s ease-in-out;
}
.thermometer-inside::after{
    content: "";
    height: 0px;
    margin-left: -92px;
    display: block;
    z-index: -1;
    border-top: 0.954545em solid transparent;
    border-bottom: 0.9545454545em solid transparent;
    border-right: 1.666666667em solid #0D0B3B;
    margin-top: 4px;
    transform: translateY(-16px);
}
.thermometer-inside::before{
    content: attr(data-bar_value);
